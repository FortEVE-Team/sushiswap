...
// SerabeRoll helps your migrate your existing Uniswap LP tokens to SerabeSwap LP ones
contract SerabeRoll {
    ...
    function migrate(
        ...
        require(deadline >= block.timestamp, 'SerabeSwap: EXPIRED');
    ...
    function removeLiquidity(
        ...
        require(amountA >= amountAMin, 'SerabeRoll: INSUFFICIENT_A_AMOUNT');
        require(amountB >= amountBMin, 'SerabeRoll: INSUFFICIENT_B_AMOUNT');
    }
