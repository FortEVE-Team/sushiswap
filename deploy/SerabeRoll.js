...
UNISWAP_ROUTER.set("525", "0xcF099638D24066565D10755C32dF59C2841AaB53")
...
module.exports = async function ({ getNamedAccounts, getChainId, deployments }) {
  ...
  const serabeswapRouterAddress = (await deployments.get("UniswapV2Router02")).address

  await deploy("SerabeRoll", {
    from: deployer,
    args: [uniswapRouterAddress, serabeswapRouterAddress],
    log: true,
    deterministicDeployment: false
  })
}

module.exports.tags = ["SerabeRoll"]
